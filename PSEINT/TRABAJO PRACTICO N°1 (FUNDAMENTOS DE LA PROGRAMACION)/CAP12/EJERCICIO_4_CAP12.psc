//Ejercicio 4: Escriba un subprograma nombrado cambio() que tenga un parámetro en número entero 
//y seis parámetros de referencia en número entero nombrados cien, cincuenta, veinte, diez, cinco y uno, respectivamente. 
